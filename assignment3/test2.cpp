...
#include "exp2.h" // our quicksort (and insertion sort)
using namespace std;
...
int main (int argc, char * const argv[]) {
   ...
   int SIZE = 50; // size of array to sort.
   int TIMES = 10000 ; // number of times to run - mean is reported.
   ...
   double sort_time = 0;
   double standard_quicksort_time = 0 ;
   double insertion_sort_time = 0 ;
   double modified_sort_time = 0;
   ...
   for( int t = 0 ; t < TIMES ; t++ ){
      ...
      start = clock();
      standardQuickSort(A3,0,SIZE-1);
      finish = clock();
      standard_quicksort_time += elapsed_time(start,finish);

      start = clock();
      modifiedQuickSort(A4,0,SIZE-1);
      finish = clock();
      modified_sort_time += elapsed_time(start,finish);

   }

   cout << "C++ sort: " << sort_time / TIMES << endl ;   
   cout << "Insertion Sort: " << insertion_sort_time / TIMES << endl ;
   cout << "standard QuickSort: " << standard_quicksort_time / TIMES << endl ;  
   cout << "modified QuickSort: " << modified_sort_time / TIMES << endl ;
